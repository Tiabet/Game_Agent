...
def build_visible_knowledge_prompt(request: dict[str, Any]) -> str:
    ...
    return (
        ...
        "If this is a synergy list, include every visible synergy row with its count, active_count, required_count, effect, and any readable required mercenary/member names. If only member icons are visible, use required_members=unknown and members=unreadable_visible_icons. If this is a recipe/combination screen, include the visible result and required materials.\n"
